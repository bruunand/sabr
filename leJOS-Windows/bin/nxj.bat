...
"%JAVA%" "-Dnxj.home=%NXJ_HOME%" "-DCOMMAND_NAME=%NXJ_COMMAND%" -classpath "%NXJ_CP_PC%" lejos.pc.tools.NXJLinkAndUpload --writeorder "LE" --bootclasspath "%NXJ_CP_NXT%" --classpath "." %*
:eof
